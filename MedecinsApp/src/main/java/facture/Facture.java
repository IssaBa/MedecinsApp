...
public class Facture {
	...
	// dossier patient
	public static void dossierPatient(Integer idpatient) throws DocumentException {
	...
	public static void infoPersoPatient(Integer idPatient) throws DocumentException {
		...
		if (patient != null) {
			...
			paralist.add(p1);paralist.add(p2);paralist.add(p3);paralist.add(p4);paralist.add(p5);paralist.add(p6);paralist.add(p7);paralist.add(p8);
	...
	// getInfoContact
	public static void getInfoContact(Integer idPatient) throws DocumentException {
		ArrayList<Paragraph> paralist = new ArrayList<Paragraph>();
		...
		if (patient != null) {
			...
			paralist.add(p1);paralist.add(p2);paralist.add(p3);paralist.add(p4);paralist.add(p5);paralist.add(p6);
	...
	// get data patient
	public static void getDataPatient(Integer idpatient) {
		try {
			// dossier numero :
	...
	// InitDocument
	public static void InitDocument(Integer idpatient) throws FileNotFoundException, DocumentException {
